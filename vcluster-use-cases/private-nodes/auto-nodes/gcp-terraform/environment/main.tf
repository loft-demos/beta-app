...
locals {
  ...
  vpc_name            = "${var.vcluster.name}-beta-${random_id.vpc_suffix.hex}-vpc"
  public_subnet_cidr  = "10.10.2.0/24"
  public_subnet_name  = "${local.vcluster_name}-beta-public"
  private_subnet_cidr = "10.10.1.0/24"
  private_subnet_name = "${local.vcluster_name}-beta-private"

  nat_name        = "${local.vcluster_name}-beta-nat"
  nat_router_name = "${local.vcluster_name}-beta-router"
